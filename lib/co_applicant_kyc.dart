...
class COApplicantKYCDocumentsScreen extends StatefulWidget {
  const COApplicantKYCDocumentsScreen({Key? key}) : super(key: key);

  @override
  State<COApplicantKYCDocumentsScreen> createState() =>
      _COApplicantKYCDocumentsScreenState();
}

class _COApplicantKYCDocumentsScreenState
    extends State<COApplicantKYCDocumentsScreen> {
  ...
  void _onSubmit() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => Guarantor1KYCDocumentsScreen()),
  ...
  // Keep the textfield visuals same as previous screen (rounded, hint style)
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            // _header(),
            CustomHeader(title: "Co.Applicant KYC Documents"),
            Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      DetailsFormHelper.sectionTitleWithSkip(
                        title: "Co. Applicant KYC Digital Validation",
                        onSkip: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder:
                                  (context) => Guarantor1KYCDocumentsScreen(),
                            ),
                          );
                        },
                      ),
