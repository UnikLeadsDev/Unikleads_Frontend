...
class Guarantor1KYCDocumentsScreen extends StatefulWidget {
  const Guarantor1KYCDocumentsScreen({Key? key}) : super(key: key);

  @override
  State<Guarantor1KYCDocumentsScreen> createState() =>
      _Gurantor1KYCDocumentsScreenState();
}

class _Gurantor1KYCDocumentsScreenState
    extends State<Guarantor1KYCDocumentsScreen> {
  ...
  void _onSubmit() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => Guarantor2KYCDocumentsScreen()),
                  ...
                  child: Column(
                    ...
                    children: [
                      DetailsFormHelper.sectionTitleWithSkip(
                        title: "1.Guarantor KYC Digital Validation",
                        onSkip: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder:
                                  (context) => Guarantor2KYCDocumentsScreen(),
                            ),
                          );
                        },
                      ),
