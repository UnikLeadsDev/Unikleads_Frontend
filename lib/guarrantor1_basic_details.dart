...
class Guarrantor1BasicDetails extends StatefulWidget {
  const Guarrantor1BasicDetails({Key? key}) : super(key: key);

  @override
  State<Guarrantor1BasicDetails> createState() =>
      _Guarrantor1BasicDetailsScreenState();
}

class _Guarrantor1BasicDetailsScreenState
    extends State<Guarrantor1BasicDetails> {
                  ...
                  child: Column(
                    ...
                    children: [
                      DetailsFormHelper.sectionTitleWithSkip(
                        title: "1.Guarrantor Details",
                        onSkip: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => const Guarrantor2BasicDetails(),
                            ),
                          );
                        },
                      ),
  ...
  void _onSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.of(
        context,
      ).push(MaterialPageRoute(builder: (context) => const Guarrantor2BasicDetails()));
    } else {
