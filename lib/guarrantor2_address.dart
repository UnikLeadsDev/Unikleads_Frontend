...
class Guarrantor2Address extends StatefulWidget {
  const Guarrantor2Address({super.key});

  @override
  State<Guarrantor2Address> createState() => _Guarrantor2AddressScreenState();
}

class _Guarrantor2AddressScreenState extends State<Guarrantor2Address> {
  ...
  final List<String> states = ['State 1', 'State 2', 'State 3']; // TODO: Replace with API data
  final List<String> districts = ['District 1', 'District 2', 'District 3']; // TODO: Replace with API data
  final List<String> cities = ['City 1', 'City 2', 'City 3']; // TODO: Replace with API data
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
              ...
              CustomHeader(title: "Guarantor Address"),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DetailsFormHelper.sectionTitleWithSkip(
                        title: "2.Guarantor Current Address",
                        onSkip: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => COApplicantKYCDocumentsScreen(),
                            ),
                          );
                        },
                      ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      // TODO: Integrate with backend API
       ...
       Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => COApplicantKYCDocumentsScreen()));  // Route to next screen
    } else {
