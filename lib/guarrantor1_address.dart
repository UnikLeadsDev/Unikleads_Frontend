...
class Guarrantor1Address extends StatefulWidget {
  const Guarrantor1Address({super.key});

  @override
  State<Guarrantor1Address> createState() => _Guarrantor1AddressScreenState();
}

class _Guarrantor1AddressScreenState extends State<Guarrantor1Address> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DetailsFormHelper.sectionTitleWithSkip(
                        title: "1.Guarantor Current Address ",
                        onSkip: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => Guarrantor2Address(),
                            ),
                          );
                        },
                      ),
  ...
  void _handleSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => Guarrantor2Address()),
